              ...
              children: <Widget>[
                Container(
                  ...
                  decoration: BoxDecoration(
                    border: new BorderDirectional(bottom: BorderSide(color: Colors.purple[600], width: 2.0)),
                  ),
                  child: Row(
                    children: <Widget>[
                    Icon(Icons.flight, color: Colors.purple[600], size: 25.0,),
                    Text(" \$219", style: TextStyle(color: Colors.purple[600], fontSize: 18.0))
                ],
                ),
                )
              ],
          ...
          child: Column(
              children: <Widget>[
                Container(
                  ...
                  Row(
                  children: <Widget>[
                  Icon(Icons.directions_railway, color: Colors.black26, size: 25.0,),
                  Text(" \$102", style: TextStyle(color: Colors.black26, fontSize: 18.0))
                ],
                ),
                )
              ],
          ...
          child: Column(
              children: <Widget>[
                Container(
                  ...
                  child: Row(
                  children: <Widget>[
                  Icon(Icons.directions_car, color: Colors.black26, size: 25.0,),
                  Text(" \$74", style: TextStyle(color: Colors.black26, fontSize: 18.0))
                ],
                ),),
              ],
            ),
